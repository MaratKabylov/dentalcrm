    ...
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <div className="flex flex-wrap gap-2">
          {context.can("communications.manage") && <Link href={`/crm/communications/new?leadId=${lead.id}`}><Button variant="secondary"><MessageCircle className="size-4" />Сообщение</Button></Link>}
